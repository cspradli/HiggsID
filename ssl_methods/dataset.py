...
## Chosen through examining of 124 different features, chose low-level features ##
...
def get_labelled_data(input1):
    ...
    #### Convert datasets into PyTorch-friendly tensors ####
...
def split(labels, n_label):
    ### Split up based on data point indexes
    ...
    ### Perform random shuffle on all dataset ###
